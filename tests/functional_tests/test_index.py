...
chrome_driver = "C:/Users/tosha/Desktop/hw_pipeline/PipelinePractice/tests/functional_tests/chromedriver.exe" if "ChromeWebDriver" not in os.environ.keys() else os.path.join(
